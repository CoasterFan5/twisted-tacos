...
Command: npx @threlte/gltf@3.0.1 static/assets/food/Models/GLB/cabbage.glb
-->
...
<T.Group bind:ref dispose={false} {...props}>
	{#await gltf}
		{@render fallback?.()}
	{:then gltf}
		<T.Mesh geometry={gltf.nodes.cabbage_1.geometry} material={gltf.materials.colormap} />
	{:catch err}
